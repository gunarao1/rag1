...
class VectorDBRAG:
    ...
    def smart_chunk_text(self, text, chunk_size=500, overlap=50):
        ...
        REDUCED chunk_size from 600 to 500 to stay under API limits!
        API limit: 36KB per embedding request
        500 chars ≈ 3-5KB (safe buffer)
        """
    ...
    def extract_text_from_json(self, json_file):
        ...
        try:
            ...
            # Add JSON structure info at the top
            header = f"JSON Document Structure:\n{'='*50}\n\n"
            return header + text
    ...
    def add_document(self, file, file_type, filename):
        ...
        try:
            ...
            if file_type == 'pdf':
                ...
                text = self.extract_text_from_json(file)
            else:  # txt, md, etc.
            ...
            # Create chunks (smaller size for API limits)
            ...
            # Create embeddings and add to ChromaDB (with error handling!)
            ...
            for i, chunk in enumerate(chunks):
                try:
                    ...
                    if len(chunk.encode('utf-8')) > 30000:  # 30KB safety margin
                        st.warning(f"Chunk {i} too large, splitting further...")
...
def main():
    ...
    with st.sidebar:
        ...
        uploaded_files = st.file_uploader(
            "Choose files",
            type=['txt', 'pdf', 'md', 'json'],  # Added JSON!

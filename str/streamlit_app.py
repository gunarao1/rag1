...
pip install streamlit google-generativeai numpy scikit-learn PyPDF2
...
STEP 4: USE IT
1. Enter your Google API key in sidebar
...
✅ Show source chunks (transparency!)
...
2. ADD SETTINGS:
- Adjust chunk size slider
- Change number of sources (top_k)
...
2. OPTIMIZE FOR SPEED
   - Cache embeddings (add @st.cache_data)
   - Use smaller chunk sizes for faster loading
...
1. CACHING:
@st.cache_data
def load_embeddings(file_content):
...
2. App not updating
   FIX: Click "Always rerun" in top-right
